...
*I initially planned to use SQL to track everything because I was learning it at the time. However, Google Sheets proved to be much easier and more accessible, so I tracked most of my banana consumption there.*
...
#### Core Problem and Questions

**Objective:**
- Structure and store data efficiently for analysis in **R** and collect enough data to perform statistical tests and **machine learning models**.
- Build this dashboard using **Flexdashboard** and **Shiny**.
