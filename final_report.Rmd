...
bar <- ggplot(aes(ripeness, metric), data = filtered_data) + 
  geom_bar(stat = "identity") + 
  facet_wrap(~metric, scales = "free_y", labeller = as_labeller(ripeness_labels)) + 
  labs(
    title = "Bananas Thrown Away by Ripeness", 
    x = "Ripeness Level"
  ) + 
  theme(
